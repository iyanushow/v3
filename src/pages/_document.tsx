...
export default class MyDocument extends Document {
	...
	render() {
		return (
			<Html lang="en">
				<Head>
					<meta name="author" content="Iyanuoluwa Sowande" />
					<meta
						name="keywords"
						content="Iyanuoluwa Sowande, shadycodes, shadycodes.dev, shadycodes.us, software developer."
					/>
					<meta property="og:type" content="website" />
					<meta
						name="description"
						content="Hi, I&#x27;m Iyanuoluwa Sowande, Software Developer and Javascript Engineer."
					/>
					<meta
					...
					<meta name="twitter:site" content="@shadycodes" />
					...
					/>
					<meta property="og:title" content="Iyanuoluwa Sowande" />
					<meta property="og:url" content="https://shadycodes.dev" />
					<meta property="og:image" content="https://i.ibb.co/jz5Qwx1/Group-7.png" />
					<meta name="apple-mobile-web-app-title" content="Iyanuoluwa Sowande" />
