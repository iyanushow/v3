const PROJECTS_DATA = [
	...
	{
		title: 'Opus Insights',
		description: 'A forecasting platform for farmers  that bring intelligent insights to agricultural supply chains.',
		about:
	...
	{
		title: 'Compiled HTML',
		description: 'A small project to make writing HTML faster and better and now components based with js',
		about:
	...
	},
	{
		...
		imageUrl: 'https://i.ibb.co/YT6fXLB/Screenshot-2020-05-04-at-4-41-05-AM.png',
		type: ['open-source', 'tools'],
	...
	},
	{
		...
		description: 'Painless utility library to handle scroll positions and methods in react.',
