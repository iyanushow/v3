...
:focus {
  outline-color:var(--shady) !important;
}
...
export const Header = styled.header`
	...
	#collapsibleNavbar .is-active {
		font-weight: 900;
		border-bottom: 1px solid var(--shady);
...
export const BackLay = styled.div`
	...
	h1 {
		...
		font-size: 29.42vmin;
		${(props) =>
			props.title === 'About Me' || props.title === 'Contact' || props.title === 'Home'
				? css`
						writing-mode: unset;
				  `
				: css`
...
export const Main = styled.main`
	background-image: repeating-linear-gradient(0deg, var(--pattern), var(--pattern) 1px, transparent 1px, transparent);
